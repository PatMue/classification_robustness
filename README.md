...
```
To generate your own lens corruptions for testing, consider using our https://github.com/PatMue/opticsbench_generate repository. Save your generated optical PSFs in the same data format as the provided psf stack and run dataset generation + inference.
...
* `/opticsaugment` contains the python code to train models with OpticsAugment. OpticsAugment itself is defined in `/opticsaugment/augment.py`.
...
```
python generate_datasets.py --testdata_path <path_to_clean_validation_images>
```
